					...
					<form method="POST" id="account_form">
						...
						<div class="wizard-header">
							<h2 class="wizard-title">
								<?php echo empty($mpt_name)?'Build Your Profile':'Welcome '.$full_name; ?>
							</h2>
						</div>
						...
						<div class="tab-content">
							<div class="tab-pane" id="account">
								<div class="row col-lg-offset-1" style="margin-top: 20px; margin-bottom:30px">
									...
									<div class="col-sm-10">
										<hr style="border-top-color: #3580a2 !important; margin-top: 10px; margin-bottom: 30px;">
									</div>
								</div>
							</div>
							...
							<div class="tab-pane" id="address">
								<div class="row col-lg-offset-1" style="margin-top: 20px; margin-bottom:30px">
									...
									<div class="col-sm-12">
										...
										<div class="col-sm-5" >
											<div class="form-group label-floating" style="margin-top: 35px">
